// Створіть функцію getDateAgo(date, days), щоб повернути день місяця,
// який був days днів після date.
// Наприклад, якщо сьогодні – 20-й, то getDateAgo(new Date(), 1)
// має бути 19-го, а getDateAgo(new Date(), 2)
// має бути 18-го.
